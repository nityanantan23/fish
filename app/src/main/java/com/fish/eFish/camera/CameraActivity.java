...
import com.fish.eFish.RegisterActivity;
import com.fish.eFish.env.ImageUtils;
import com.fish.eFish.env.Logger;
import com.fish.eFish.fish_detail;
import com.fish.eFish.tflite.Classifier.Device;
import com.fish.eFish.tflite.Classifier.Model;
import com.fish.eFish.tflite.Classifier.Recognition;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public  void onCreate(final Bundle savedInstanceState) {
    ...
    plusImageView.setOnClickListener((View.OnClickListener) this);
    minusImageView.setOnClickListener((View.OnClickListener) this);
  ...
  protected void setFragment() {
    ...
    if (useCamera2API) {
      ...
      fragment =
              new LegacyCameraConnectionFragment((Camera.PreviewCallback) this, getLayoutId(), getDesiredPreviewFrameSize());
    }
